(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["DBNApi-Browser"] = factory();
	else
		root["DBNApi-Browser"] = factory();
})(window, function() {
...
/* WEBPACK VAR INJECTION */(function(process, Buffer, global) {var capability = __webpack_require__(3)
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(2), __webpack_require__(1).Buffer, __webpack_require__(0)))
...
Object.defineProperty(exports, "__esModule", { value: true });
const BrowserClient_1 = __webpack_require__(9);
exports.BrowserClient = BrowserClient_1.BrowserClient;
exports.Client = BrowserClient_1.BrowserClient;
exports.default = BrowserClient_1.BrowserClient;
...
Object.defineProperty(exports, "__esModule", { value: true });
const https_1 = __webpack_require__(10);
const cross_fetch_1 = __importDefault(__webpack_require__(19));
const User_1 = __webpack_require__(20);
const Bot_1 = __webpack_require__(21);
const Es6Polyfill = __importStar(__webpack_require__(22));
Es6Polyfill.polyfill();
const package_json_1 = __importDefault(__webpack_require__(23));
...
class BrowserClient {
    constructor(token, clientid, ownerid) {
        ...
        this.sessionid = null;
        this.version = BrowserClient.getVersion();
        ...
        this.request = new (class Request {
            ...
            post(endpoint, data) {
                ...
                return new Promise((resolve, reject) => {
                    try {
                        cross_fetch_1.default(`https://${this.url}/api/${endpoint}`, {
                            method: 'post',
        ...
        if (token || token !== undefined || token !== '') {
            this.tokenValidator(token).then((valid) => {
                if (valid === false) {
                    throw new Error(`${header} Your token is invalid!`);
                }
                else {
                    if (valid === true) {
...
/* WEBPACK VAR INJECTION */(function(global) {var ClientRequest = __webpack_require__(12)
var response = __webpack_require__(5)
var extend = __webpack_require__(17)
var statusCodes = __webpack_require__(18)
var url = __webpack_require__(7)
...
/* WEBPACK VAR INJECTION */(function(Buffer, global, process) {var capability = __webpack_require__(3)
var inherits = __webpack_require__(4)
var response = __webpack_require__(5)
var stream = __webpack_require__(6)
var toArrayBuffer = __webpack_require__(16)
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(1).Buffer, __webpack_require__(0), __webpack_require__(2)))
